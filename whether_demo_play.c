            ...
            */
            if (game_info->current_attack == 0){
                if (game_info->previous_card.rank == user_input_card.rank ||
                    ...
                    printf("Invalid Input ! Try again ! \n");
                    printf("user_input_number%d\n",user_input_card_number);
                    user_input_card_number=user_input_card_number+1;
                    if (user_input_card_number > p[game_info->who_play_now].hand_card_left){
                        user_input_card_number=0;
                    }
                    flag = 0;
                }
            }
